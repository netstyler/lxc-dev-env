...
$config->{'lxc'}{'vm'}{'wa-dev-cerebro'}{'ip'} = '172.16.0.13';
$config->{'lxc'}{'vm'}{'wa-dev-cerebro'}{'roles'} = 'wa,cerebro';
...
$config->{'lxc'}{'vm'}{'wa-dev-own-cloud'}{'ip'} = '172.16.0.19';
$config->{'lxc'}{'vm'}{'wa-dev-own-cloud'}{'roles'} = 'wa,owncloud';
